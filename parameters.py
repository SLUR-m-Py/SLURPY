...
L_help = "The name of the restriction site enzyme(s) (or library prep) used in Hi-C sample creation. Default is %s. Options include Arima, MboI, DpnII, Ddel, Sau3AI, and HindIII; passing multiple sets of sites is also allowed. Note: passing none (i.e. Dovetail) is allowed but checks for restriction sites and dangling ends will be skipped."%lib_default[0]
